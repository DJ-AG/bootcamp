...
router
  ...
  .post(createBootcamp);  // Route to create a new bootcamp
...
router
  ...
  .put(updateBootcamp)   // Route to update a bootcamp by ID
  .delete(deleteBootcamp);  // Route to delete a bootcamp by ID
