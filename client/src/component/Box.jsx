const Box = ({ data }) => (
  <div className="w-1/2 lg:w-2/5 cursor-pointer p-4 m-4 rounded-lg shadow-lg flex flex-col justify-between hover:bg-gray-800">
      {/* Image at the top */}
      ...
      <div className="flex justify-between text-gray-400">
          <div className="pr-2"> {/* Left column */}
